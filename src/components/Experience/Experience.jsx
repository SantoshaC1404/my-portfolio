...
const Experience = () => {
  return (
    <section
      id="experience"
      className="py-20 px-[1vw] md:px-[7vw] lg:px-[16vw] font-sans bg-skills-gradient clip-path-custom-2 relative"
    >
      {/* Section Title */}
      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            {/* Circle Marker */}
            <div className="absolute left-1/2 transform -translate-x-1/2 bg-gray-900 border-4 border-[#8245ec] w-14 h-14 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-20">
              <img
                src={experience.img}
